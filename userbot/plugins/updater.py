...
async def updater(message):
    ...
    if not changelog:
        await message.edit("`⚡ Espera aí seu gay, tô já atualizando. . . 😅😅`")
...
async def deploy_start(tgbot, message, refspec, remote):
    ...
    await message.edit(
        "🤟✞︎t͛ẞ̸ 𝖑𝖊ɠêɳ̃dẞø✞︎ Está atualizando !!!\nEspere 5 𝚖𝚒𝚗utos e digite `.op` ou `.alive` para ϲнєϲκ ιƒ ι αм οи ѕιя ♦"
    )
